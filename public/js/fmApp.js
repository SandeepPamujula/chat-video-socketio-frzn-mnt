...
function App(logContainer)
{
    ...
    console.log("app 1");
    this.icelinkServerAddress = '';
    this.websyncServerUrl = ''; // WebSync On-Demand
    ...
    fm.icelink.webrtc.setApplet({
        path: './lib/fm/fm.icelink.webrtc.applet.jar',
    ...
    fm.icelink.webrtc.setActiveX({
        path_x86: './lib/fm/FM.IceLink.WebRTC.ActiveX.x86.cab',
        path_x64: './lib/fm/FM.IceLink.WebRTC.ActiveX.x64.cab'
    });
...
{
    console.log("app 1 startSignalling");
...
{
    console.log("app 1 stopSignalling");
    if (this.signalling)
    {
...
{
    console.log("app 1 startLocalMedia");
...
{
        console.log("app 1 stopLocalMedia");
...
{
            console.log("app 1 startConference");
...
{
                console.log("app 1 stopConference");
